...
$day_sql = "SELECT * FROM opening_days
WHERE day_name='$day_of_week'";
...
if($day_row['is_open'] == 0){

    $error = "Restaurant is closed on $day_of_week.";
    ...
    $current_persons = $row['total_persons'];

    if($current_persons == null){
...
if(!isset($error)){
    ...
    if(($current_persons + $persons) > $max_capacity){
